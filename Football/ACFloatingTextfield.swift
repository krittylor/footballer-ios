...
//    
//     @IBInspectable  var selectedLineColor : UIColor = UIColor(red: 0/256.0, green: 122/256.0, blue: 255/256.0, alpha: 1.0)
//    
//     @IBInspectable  var customPlaceHolderColor : UIColor = UIColor.white
//    
//     @IBInspectable  var selectedPlaceHolderColor : UIColor = UIColor(red: 0/256.0, green: 122/256.0, blue: 255/256.0, alpha: 1.0)
//    
//    
//    
//    //MARK:- Set Text
...
//        labelPlaceholder?.textColor = customPlaceHolderColor
...
//            self.labelPlaceholder?.textColor = self.customPlaceHolderColor;
//
//        }
//        
//        UIView.animate(withDuration: 0.2, animations: {
...
@objc open class ACFloatingTextfield: UITextField {
    ...
    @IBInspectable open var selectedLineColor : UIColor = UIColor(red: 0/256.0, green: 122/256.0, blue: 255/256.0, alpha: 1.0)
    
    @IBInspectable open var customPlaceHolderColor : UIColor = UIColor.white
    
    @IBInspectable open var selectedPlaceHolderColor : UIColor = UIColor(red: 0/256.0, green: 122/256.0, blue: 255/256.0, alpha: 1.0)
...
fileprivate extension ACFloatingTextfield {
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.textColor = customPlaceHolderColor
